import sys, random
sys.path.insert(1,"../python/retrieval_system/")
try:
    import include
except:
    pass
import ListwiseLearningSystemREMBO, environment, evaluation, query

d = 3

learner = ListwiseLearningSystemREMBO.ListwiseLearningSystemREMBO(64,'-w random -c comparison.ProbabilisticInterleave -r ranker.ProbabilisticRankingFunction -s 3 -d 0.1 -a 0.01')
